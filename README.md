...
[![My Skills](https://skillicons.dev/icons?i=java,js,react,html,c,cpp,css,spring,hibernate,heroku,jquery,mysql,nodejs,aws,mongodb,maven,postgres,git,bootstrap)](https://skillicons.dev)
