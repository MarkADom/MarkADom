...
[![My Skills](https://skillicons.dev/icons?i=java,cpp,js,kotlin,react,html,css,spring,hibernate,heroku,jquery,mysql,nodejs,aws,mongodb,maven,gradle,postgres,git,bootstrap,postman)](https://skillicons.dev)
