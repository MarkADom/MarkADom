...
[![My Skills](https://skillicons.dev/icons?i=c,java,cpp,js,react,html,css,spring,hibernate,heroku,jquery,mysql,nodejs,aws,mongodb,maven,gradle,postgres,git,bootstrap,postman)](https://skillicons.dev)
